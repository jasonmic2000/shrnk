      ...
      <section className="grid items-start gap-10 md:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          ...
          <form
            ...
            className="border-border/80 bg-card hover:border-foreground/30 hover:bg-muted/40 focus-within:border-primary/70 focus-within:ring-primary/30 flex flex-col gap-3 rounded-2xl border-2 p-4 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-150 focus-within:ring-2 hover:shadow-md md:flex-row md:items-center"
          >
            <Input
              value={url}
  ...
  "redirectType": 302
      ...
      <section className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="border-border bg-card hover:border-foreground/25 hover:bg-muted/40 rounded-2xl border p-5 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-150 hover:-translate-y-0.5 hover:shadow-md">
      ...
      <section className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="border-border bg-card hover:border-foreground/25 hover:bg-muted/40 flex items-start gap-4 rounded-2xl border p-5 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-150 hover:-translate-y-0.5 hover:shadow-md">
      ...
      <section className="space-y-6">
        ...
        <div className="border-border bg-card hover:border-foreground/25 hover:bg-muted/20 rounded-3xl border p-6 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-150 hover:-translate-y-0.5 hover:shadow-md">
